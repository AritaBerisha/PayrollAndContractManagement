...
public class MainEmp extends Application {
	...
	private TextField BeginDate = new TextField();
	...
	public void start(Stage primaryStage) {
		...
		formPane.addRow(4, new Label("Salary: "), salaryTxt);
		formPane.addRow(5, new Label("Begin Date: "), BeginDate);
		formPane.addRow(6, new Label("EndDate: "), EndDate);
...
//		idTxt.setDisable(true);
		...
		column1.setCellValueFactory(new PropertyValueFactory("Contract_date_begin"));
		column1.setPrefWidth(60);
		
		TableColumn<String, Employer> column2 = new TableColumn<>("Position");
		column2.setCellValueFactory(new PropertyValueFactory("Contract_date_due"));
		column2.setPrefWidth(150);
		
		TableColumn<String, Employer> column3 = new TableColumn<>("Department");
		column3.setCellValueFactory(new PropertyValueFactory("job_title"));
		column3.setPrefWidth(150);
		
		TableColumn<String, Employer> column4 = new TableColumn<>("Salary");
		column4.setCellValueFactory(new PropertyValueFactory("department"));
		column4.setPrefWidth(120);
		
		TableColumn<String, Employer> column5 = new TableColumn<>("Begin Date");
		column4.setCellValueFactory(new PropertyValueFactory("EmpId"));
		column4.setPrefWidth(120);
		
		TableColumn<String, Employer> column6 = new TableColumn<>("End Date");
		...
		EmployersTable.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(event -> {
               ...
               BeginDate.setText( String.valueOf(row.getItem().getBeginDate()));
              EndDate.setText(String.valueOf(row.getItem().getEndDate()));
            });
	...
	EmployersTable.getColumns().add(column1);
		...
		EmployersTable.getColumns().add(column5);
		EmployersTable.getColumns().add(column6);
	...
	public void insertEmployer() {
		...
		if(Employer.addEmployer(Integer.parseInt(idTxt.getText()),positionTxt.getText(), deptTxt.getText(), Integer.parseInt(salaryTxt.getText()), BeginDate.getText(), EndDate.getText())) {
			showEmployers();
			clearForm();
		}
	}
	...
	public void updateEmployer() {
		if(Employer.updateEmployer(Integer.parseInt(idTxt.getText()), positionTxt.getText(), deptTxt.getText(), Integer.parseInt(salaryTxt.getText()), BeginDate.getText(), EndDate.getText())) {
			showEmployers();
			clearForm();
		}
	}
